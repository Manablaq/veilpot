// Gate 2C-C3B2A real Pool+Vault Autopilot integration tests. Local Hardhat FHEVM only.
...
describe("Veilpot Gate 2C-C3B2A real confidential Autopilot integration", function () {
