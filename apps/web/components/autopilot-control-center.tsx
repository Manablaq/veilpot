  ...
  return (
    <section className="workspace-stack">
      <article className="workspace-card block">
        ...
        <span className="eyebrow">LIVE AUTOPILOT</span>
        <h2>One immutable policy, explicit funding, owner controls.</h2>
        <p>
          Live plans are discovered from owner-indexed Sepolia events and reconciled against Vault
          metadata. Confidential period amounts, remaining budgets, and Vault funds are not
          decrypted by discovery.
        </p>
