            ...
            <>
              ...
              {depositReady ? (
                ...
                <InlineNotice title="Active private saver" tone="private">
                  Principal remains sealed. Confidential withdrawal and explicit zero-principal
                  deregistration are available below on the corrected V2.x Pool.
                </InlineNotice>
              ) : null}
            </>
          )}
