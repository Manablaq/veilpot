...
export function MeridianVeilDrawControl({
  ...
  return (
    <section className="workspace-stack">
      <article className="workspace-card block">
        ...
        <span className="eyebrow">VEILDRAW · V2.x · THREE PRIZES</span>

        <h2>One immutable savings round. Three independent private winners.</h2>

        <p>
          Meridian drives the corrected V2.x Pool and non-custodial Engine directly. Saver weights,
          random candidates, accepted targets, selected shards and winner predicates remain
          encrypted. Only the exact proof consequences explicitly authorized by the contracts can be
          publicly decrypted.
        </p>
        ...
        >
          ...
          Refresh canonical V2.x draw state
        </button>
      </article>
        ...
        {snapshot?.childDraws.length === 0 ? (
          <div className="financial-state-card">
            ...
            <div>
              ...
              <p>Meridian does not fabricate draw state, winners or prize values.</p>
            </div>
          </div>
        ) : null}
        ...
        {allLatestChildrenFinalized ? (
          <div className="financial-state-card">
            ...
            <div>
              ...
              <p>
                The round is ready for M6-B yield recognition, confidential prize funding, encrypted
