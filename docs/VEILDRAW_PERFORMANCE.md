...
The fixed seven-comparison encrypted binary search used 4,056,064 global HCU, 1,923,032 sequential
HCU, and 795,573 EVM gas. It emits three public-decryption handles in one ordered proof request:
bucket exponent, zero flag, and supported-domain flag.
...
|   m | Candidate global | Candidate seq. | Candidate gas | Serial global | Serial seq. | Serial gas | Balanced global | Balanced seq. | Balanced gas |
| --: | ---------------: | -------------: | ------------: | ------------: | ----------: | ---------: | --------------: | ------------: | -----------: |
|   1 |          240,000 |        240,000 |       214,866 |       106,066 |      82,034 |    228,099 |          57,032 |        57,032 |      150,945 |
|   2 |          480,000 |        240,000 |       314,844 |       212,068 |     139,034 |    281,455 |         138,032 |       114,000 |      206,764 |
|   4 |          960,000 |        240,000 |       548,983 |       424,072 |     253,034 |    388,168 |         300,032 |       171,000 |      274,722 |
|   8 |        1,920,000 |        240,000 |     1,017,245 |       848,080 |     481,034 |    601,594 |         624,032 |       228,000 |      410,420 |
|  16 |        3,840,000 |        240,000 |     1,953,742 |     1,696,096 |     937,034 |  1,028,449 |       1,272,032 |       285,000 |      681,601 |
...
| Participants | Global HCU | Sequential HCU |   EVM gas | Limit observation                                           |
| -----------: | ---------: | -------------: | --------: | ----------------------------------------------------------- |
|            1 |    976,096 |        758,064 |   435,928 | comfortable                                                 |
|            2 |  1,952,128 |      1,017,064 |   583,514 | comfortable                                                 |
|            4 |  3,904,192 |      1,535,064 |   881,561 | comfortable                                                 |
|            8 |  7,808,320 |      2,571,064 | 1,489,485 | 51.4% of sequential limit                                   |
|           16 | 15,616,576 |      4,643,064 | 2,752,606 | 92.9% of sequential limit; insufficient production headroom |
